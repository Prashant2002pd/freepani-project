...
export const ProductCard = ({ title, text }) => {
  return (
    <div className="rounded-2xl aspect-square bg-cyan-100 p-5 w-1/5 text-start">
      <h1 className="text-3xl font-bold">{title}</h1>
      <h2 className="text-xl m-1 text-primary-darkblue">{text}</h2>
