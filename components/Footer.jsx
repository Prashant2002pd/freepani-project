    ...
    <div className="fixed text-primary-white bottom-0 z-[-1] grid justify-center bg-primary-darkblue w-full h-96">
        <div className="grid grid-cols-3 justify-center w-full py-10 divide-x-2 px-32 divide-primary-lightblue">
          <div className="w-full flex flex-col justify-center px-10 items-center">
            ...
            <p className="text-gray-500 text-center">Sign up to receive information about new events and specials</p>
          ...
          <div className="w-full flex flex-col justify-start pt-2 px-10 items-center">
            ...
            <p className="text-gray-500 text-lg font-extralight text-center">MON - SAT - 10.00 AM to 6.00 PM (IST) +91 9892978101 | +91-2249736396 info@root7.in</p>
          </div>
          <div className="w-full flex flex-col justify-start pt-2 px-10 items-center">
