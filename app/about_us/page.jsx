  ...
  return (
    <div className='pt-24 bg-primary-black divide-y-2 divide-gray-800 text-primary-white w-screen h-full'>
      <div className='grid grid-cols-2 w-full gap-4 place-items-center'>
        <div className=' w-9/12 pl-12 pb-24'>
          <Breadcrumbs separator="|" className='rounded-full bg-gray-600 text-primary-white py-1 px-4 mb-4'>
            ...
            <Link href="/about_us" className='text-primary-white hover:opacity-60'>About</Link>
          </Breadcrumbs>
          <h1 className='font-bold text-7xl pr-12'><span className='text-primary-green'>Lorem ipsum dolor</span> sit amet consectetur adipisicing elit. </h1>
      ...
      <div className=' h-4/6 px-24 py-12'>
        <h1 className='font-semibold text-5xl pr-12'>Why Choose Us?</h1>
        <div className='h-4/6 flex justify-between items-center'>
          <div className='w-64'>
            <ul className='list-disc text-sm flex flex-col justify-between gap-12'>
        ...
        <div className='flex justify-between gap-12 py-6'>
          <div className='w-4/12 aspect-square bg-gray-800 hover:bg-primary-green text-white rounded-2xl'></div>
          <div className='w-4/12 aspect-square bg-gray-800 hover:bg-primary-green text-white rounded-2xl'></div>
          <div className='w-4/12 aspect-square bg-gray-800 hover:bg-primary-green text-white rounded-2xl'></div>
        </div>
